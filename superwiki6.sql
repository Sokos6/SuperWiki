...
--
CREATE DATABASE IF NOT EXISTS `superwiki` DEFAULT CHARACTER SET latin1;

 DROP USER `admin`@`localhost`; /* Uncomment to run script again */
CREATE USER `admin`@`localhost` IDENTIFIED BY 'admin';
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, DROP ON superwiki.* TO `admin`@`localhost`;
...
-- Dump completed on 2016-02-16 21:36:16
